...
export default function Sidebar({ active = "assign", onNav = () => {} }) {
  return (
    <aside className="hidden md:flex fixed inset-y-5 left-6 w-50 panel flex flex-col justify-between p-6 z-40 shadow">
      <div>
        <div className="flex justify-center mb-6">
          <div className="w-40 h-20 rounded-lg bg-white p-2 flex items-center justify-center border border-indigo-100">
            <img src={Logo} alt="Company Logo" className="object-contain max-w-full max-h-full" />
          </div>
        </div>
      ...
      <div>
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-3 rounded-lg bg-gray-800 text-white hover:bg-gray-700"
        >
